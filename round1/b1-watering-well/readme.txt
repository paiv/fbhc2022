Note: The only difference between this chapter and chapter 2 is that here,
coordinates are only up to 3,000.

Boss Rob just planted N happy little trees in his yard, which can be represented
on a Cartesian plane. The ith tree is located at coordinates t_i = (A_i, B_i).
Now, he's looking for the best spot to build a well in order to provide water to
